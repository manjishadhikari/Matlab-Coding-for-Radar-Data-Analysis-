% script run_IceBedCoherenceIndex_tracker
%
% Script for running IceBedCoherenceIndex_tracker: find coherence index
...
IceBedCoherenceIndex_tracker(params,param_override);
